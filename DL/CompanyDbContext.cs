...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=RSPLLT423\\SQLEXPRESS;Initial Catalog=CompanyDB;Integrated Security=True; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmployeeId, "IX_Employee").IsUnique();

            entity.HasIndex(e => e.EmployeeEmail, "UQ__Employee__05BE9A84A6E34140").IsUnique();
        ...
        modelBuilder.Entity<EmployeeMapping>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ManagerId, e.EmployeeId }, "uk_map").IsUnique();

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.EmployeeId).HasColumnName("employeeId");
            entity.Property(e => e.ManagerId).HasColumnName("managerId");

            entity.HasOne(d => d.Employee).WithMany(p => p.EmployeeMappingEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EmployeeMapping_Employee1");

            entity.HasOne(d => d.Manager).WithMany(p => p.EmployeeMappingManagers)
        ...
        {
            entity.HasIndex(e => new { e.ProjectId, e.EmployeeId }, "uks_map").IsUnique();
